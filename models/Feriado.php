...
class Feriado extends model {
	...
	/*
	* Busca um feriado especificado pelo $id do usuário logado no sistema
	*/
	public function getFeriaddo($id, $usu_id) {
		$array = array();

		$sql = $this->db->prepare("SELECT * FROM feriados WHERE id = :id AND usu_id = :usuario");
		$sql->bindValue(":id", $id);
		$sql->bindValue(":usuario", $usu_id);
		$sql->execute();
